    ...
    <article class="container">
      ...
      <section class="hero" id="home">
        ...
        <figure class="hero-banner">
          ...
          <picture>
            <source srcset="./assets/images/3.png" media="(min-width: 768px)">
            <source srcset="./assets/images/3.png" media="(min-width: 500px)">
        ...
        <ul class="stats-list">
          ...
          <li>
            <a href="#" class="stats-card">
              ...
              <h2 class="h2 card-title">
                5+ <strong>Completed Projects</strong>
              </h2>
      ...
      <section class="about" id="about">
        ...
        <figure class="about-banner">
          <!-- <img src="./assets/images/5.png" alt="A man in a alice blue shirt with a thinking expression"
            class=s"w-100"> -->
        </figure>
        ...
        <div class="about-content section-content">
          ...
          <h2 class="h3 section-title">Need a Creative Website? I can Help You!</h2>

          <p class="section-text">
            Hi! I’m Jerson Villaceran, and I’m an anspiring developer who has passion for building clean web applications with intuitive
      ...
      <section class="skills" id="skills">
        ...
        <div class="skills-box" data-skills-box>
          ...
          <ul class="skills-list">
            ...
            <li>
              <div class="skill-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/php4 (1).png" alt="Vue logo">
                </div>
              </div>
            </li>
            ...
            <li>
              <div class="skill-card">
                ...
                <div class="card-icon">
                  <img src="./assets/images/c.png" alt="SASS logo">
                </div>
              </div>
            </li>
          ...
          <ul class="tools-list">
            ...
            <li>
              <div class="skill-card">
                <div class="tooltip">Kali linux</div>

                <div class="card-icon">
                  <img src="./assets/images/KALI.png" alt="ClickUp logo">
                </div>
              </div>
            </li>
        ...
        <ul class="project-list">
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="./assets/images/project1.png" class="w-100" alt="A macintosh on a yellow background.">
              </figure>

              <div class="card-content">
                <h3 class="h4 card-title">SSC VOTING SYSTEM 01</h3>

                <time class="publish-date" datetime="2024-04">December 8 2024</time>
              </div>
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="./assets/images/tooltech.png" class="w-100" alt="On a Blue background, a Wacom and a mouse.">
              </figure>

              <div class="card-content">
                <h3 class="h4 card-title">Web/Mobile App: Tooltech 02</h3>
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="./assets/images/mcc.png" class="w-100"
                  alt="A Cassette tape on a mellow apricot background.">
              </figure>

              <div class="card-content">
                <h3 class="h4 card-title">C#: MccParking 03</h3>
          ...
          <li>
            <a href="#" class="project-card">
              ...
              <figure class="card-banner">
                <img src="./assets/images/weather-app.jpg" class="w-100"
                  alt="Blue digital watch on a dark liver background.">
              </figure>

              <div class="card-content">
                <h3 class="h4 card-title">Weather App</h3>
          ...
          <ul class="contact-list">
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="tel:01234567789" class="contact-info">(63) 995 037 4023</a>
<!-- 
                <a href="tel:09765432200" class="contact-info">(63) 995 037 4023</a> -->
              </div>
            ...
            <li class="contact-list-item">
              ...
              <div class="wrapper">
                ...
                <a href="mailto:info@jack.com" class="contact-info">villaceranjerson@55gmail.com</a>

                <!-- <a href="mailto:support@jack.com" class="contact-info">villaceranjerson55@gmail.com</a> -->
              </div>
            ...
            <li>
              <ul class="contac-social-list">
                ...
                <li>
                  <a href="https://www.facebook.com/jerson.villaceran.2024/" class="contact-social-link">
                    <div class="tooltip">Facebook</div>
  ...
  <footer class="footer">
    <div class="container">
      ...
      <p class="h1 logo">
        <a href="#">
        Jerson Villaceran<span>.</span>
        </a>
      </p>

      <p class="copyright">
        &copy; 2024 <a href="#">Jerson</a>. All rights reserved
      </p>
